...
const Signup = () => {
  const { formData, handleChange, handleSubmit, googleHandler, FBHandler, TwitterHandler, GithubHandler} = useContext(AuthProvider)
